<div class="left-sidebar" id="hamburgerButton">
 <!-- Adding an ID to the wrapper -->
    <nav class="ts-sidebar">
        <ul class="ts-sidebar-menu">
            ...
            <li>
                ...
                <ul>
                    <li><a href="manageuser.php">Update User</a></li>
            ...
            <li><a href="admin-view-syslogs.php"><i class="fa fa-cog fa-spin"></i> System Logs</a></li>
        </ul>
    </nav>
</div>
