...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" class="badge badge-success"  onclick="return confirm('Do you really want to Confirm this booking')"> Confirm</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" class="badge badge-danger" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a>
</td>
